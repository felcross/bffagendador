...
import com.projetozero.bffagendador.business.TarefasService;
...
public class TarefasController {
    ...
    @ApiResponse(responseCode = "403", description = "Tarefa id não encontrada")
    @ApiResponse(responseCode = "401", description = "Usuário não autorizado")
    public ResponseEntity<TarefasDTOResponse> alteraStatusNotificacao(@RequestParam("status") StatusTarefaEnum status,
